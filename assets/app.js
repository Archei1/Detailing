...
/* ИСПРАВЛЕНИЕ: Параллакс работает только на экранах больше 1024px */
...
/* ИСПРАВЛЕНИЕ: Canvas отключен на мобильных (меньше 768px) для экономии ресурсов */
if (overlay && window.matchMedia("(min-width: 769px)").matches) {
